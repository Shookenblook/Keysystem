...
-- Animate bar filling while we wait
...
TweenService:Create(SplashCard,
	TweenInfo.new(0.5, Enum.EasingStyle.Back, Enum.EasingDirection.Out),
	{ Position = UDim2.new(0.5, 0, 0.45, 0), BackgroundTransparency = 0 }
):Play()

-- ── Run the check (yields) ──
...
if not granted then
	...
	TweenService:Create(SplashBar,
		...
		{ Size = UDim2.new(1, 0, 1, 0), BackgroundColor3 = Color3.fromRGB(210, 55, 55) }
	):Play()
	...
	task.wait(0.4)
	SplashGui:Destroy()
	return  -- stop the whole script here
end

-- ── GRANTED — finish bar, fade splash, then load GUI ──
print("✅ Access Granted! Loading Mango Premium...")
SplashSub.Text       = "✅  Access granted!"
SplashSub.TextColor3 = Color3.fromRGB(80, 210, 120)
TweenService:Create(SplashBar,
	TweenInfo.new(0.3, Enum.EasingStyle.Quad),
	{ Size = UDim2.new(1, 0, 1, 0), BackgroundColor3 = Color3.fromRGB(60, 210, 90) }
):Play()
task.wait(0.8)
TweenService:Create(SplashBG,
